# Generated by Django 2.2.19 on 2023-02-04 18:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='posts.Ingredient', verbose_name='Ингредиент')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.ManyToManyField(help_text='Ингредиент', related_name='recipe', through='posts.IngredientAmount', to='posts.Ingredient', verbose_name='Ингредиент')),
                ('tags', models.ManyToManyField(help_text='Тег', related_name='recipe', to='posts.Tag', verbose_name='Тег')),
            ],
            options={
                'verbose_name': 'Рецепт',
